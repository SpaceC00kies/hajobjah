  ...
  return (
    <div className="container mx-auto p-6 sm:p-10 max-w-3xl my-8">
      <div className="bg-white dark:bg-dark-cardBg shadow-xl rounded-xl p-8 md:p-12 border border-neutral-DEFAULT dark:border-dark-border">
        <h2 className="text-2xl sm:text-3xl font-quicksand font-bold text-accent dark:text-dark-accent-DEFAULT mb-6 text-center">
        ...
        <div className="space-y-5 text-neutral-dark dark:text-dark-textMuted leading-relaxed font-normal text-base sm:text-lg">
          ...
          <ul className="list-disc list-inside space-y-2 pl-4 bg-primary/10 dark:bg-dark-primary-DEFAULT/10 p-4 rounded-lg border border-primary/30 dark:border-dark-primary-DEFAULT/30">
            <li>
            ...
            <li>
              หากพบพฤติกรรมต้องสงสัย โปรดแจ้งทีมงานทันที (ผ่านช่องทางที่ระบุในหน้า "เกี่ยวกับเรา" หากมี)
            </li>
          </ul>
          ...
          <p className="text-xl sm:text-2xl font-semibold text-primary dark:text-dark-primary-DEFAULT pt-5 text-center italic">
